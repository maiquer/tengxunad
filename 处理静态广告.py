...
with open('/cos_public/cephfs/tesla_common/deeplearning/dataset/AI_Race/ads_data/map_ad_static.out', 'r') as f:
...
user_feature.to_csv('/cos_person/tencent/train/Ad_Static_Feature_Data.csv', index=False, header=False)
